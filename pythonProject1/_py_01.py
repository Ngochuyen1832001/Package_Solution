#a web requires the users to input username and pass to register. Write program to check the validity of pass input by users
#1. At least 1 letter [a-z]
#2. At least 1 num [0-9]
#1. At least 1 letter [A-Z]
#3. At least 1 character [$#@]
#4. Minimum lenght :6
#5. Maximum length :12
#accept a sequence comma separate pass and check according the above criteria...
